...
describe('fs-driver', function () {
  describe('interface', function() {
    ...
    it('should expose the `_absolutePath` method', function (done) {
      expect(driver._absolutePath).to.exist();
      expect(typeof driver._absolutePath).to.equal('function');
      done();
    });

    it('should expose the `move` method', function (done) {
      expect(driver.move).to.exist();
      expect(typeof driver.move).to.equal('function');
      done();
    });

    it('should expose the `copy` method', function (done) {
      expect(driver.copy).to.exist();
      expect(typeof driver.copy).to.equal('function');
      done();
    });

    it('should expose the `grep` method', function (done) {
      expect(driver.grep).to.exist();
      expect(typeof driver.grep).to.equal('function');
      done();
    });

    it('should expose the `sed` method', function (done) {
      expect(driver.sed).to.exist();
      expect(typeof driver.sed).to.equal('function');
      done();
    });
  }); // end 'interface'
